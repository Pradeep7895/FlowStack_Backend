namespace FlowStack.TaskService.Helpers;

// Task-service needs board-service for:
// 1. IsMember    — can this user create/edit cards on this board?
// 2. IsAdmin     — can this user delete cards?
